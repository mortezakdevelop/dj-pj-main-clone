...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        DEVICE_ID = Settings.Secure.getString(this@MainActivity.contentResolver,
    ...
    private fun subscribeToObservers() {
        ...
        mainViewModel.curPlayingSong.observe(this) {
            ...
            var mediaId = it.bundle.getString(METADATA_KEY_MEDIA_ID)
            mediaId?.let {
                curPlayingSong = swipeSongAdapter.songs.find { song ->
